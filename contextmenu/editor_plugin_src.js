...
(function() {
	...
	tinymce.create('tinymce.plugins.ContextMenu', {
		...
		_getMenu : function(ed, e) {
			...
			if(e.target.nodeName == 'AREA' || e.target.getAttribute('usemap')){
	            m.addSeparator();
	            m.add({title: "Edit Image mapping", icon: "imagemap", cmd: ed.plugins.imagemap ? "mceImagemapContex" : "mceImagemapContex", ui: true});
            }
			m.addSeparator();
