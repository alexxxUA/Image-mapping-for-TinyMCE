    ...
    tinymce.create('tinymce.plugins.ImagemapPlugin', {
        init : function(ed, url) {
            ...
            ed.addCommand('removeEditImageMap', function() {
                tinyMCE.activeEditor.dom.remove(tinyMCE.activeEditor.dom.select('[usemap="#'+usemap+'"]'));
                tinyMCE.activeEditor.dom.remove(tinyMCE.activeEditor.dom.select('[name="'+usemap+'"]' ));
            });
