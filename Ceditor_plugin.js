    ...
    tinymce.create("tinymce.plugins.ContextMenu", {
        init: function (e) {
            ...
            f = e.onContextMenu.add(function (j, k) {
                ...
                h._getMenu(j, k).showMenu(k.clientX || k.pageX, k.clientY || k.pageY);
        ...
        _getMenu: function (e, el) {
            ...
            if(el.target.nodeName == 'AREA' || el.target.getAttribute('usemap')){
	            d.addSeparator();
	            d.add({
	                title: "Edit Image mapping",
	                icon: "image",
	                cmd: e.plugins.imagemap ? "mceImagemapContex" : "mceImagemapContex"              
	            });            	
            }
            d.addSeparator();
            d.add({
