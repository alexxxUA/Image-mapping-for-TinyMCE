	function createAdvancedEditor(config) {
	    ...
	    tinyMCE.init({
			...
			// Theme options
			theme_advanced_buttons1 : "newdocument,template,|,print,|,cut,copy,paste,pastetext,pasteword,cleanup,|,search,replace,|,undo,redo,|,link,unlink,anchor,|,image,imagemap,media,table,|,visualchars,visualaid,help,|,code,fullscreen",
